    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            <ul class="nav-list">
                ...
                <li class="nav-item">
                    <a href="../exams/index.php" class="nav-link">
    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            ...
            <div class="stat-card animate-in delay-2">
                ...
                <div class="mt-3">
                    <p class="text-muted mb-2">Mostrando página <?php echo $page; ?> de <?php echo $total_paginas; ?> (<?php echo $limit; ?> registros por página)</p>
                    <p class="text-muted mb-2">Ingresos acumulados hoy: <strong>Q<?php echo number_format($today_revenue, 2); ?></strong></p>
                    <p class="text-muted mb-0">Ingresos acumulados esta semana: <strong>Q<?php echo number_format($week_revenue, 2); ?></strong></p>
                </div>
            </div>
        </main>
    </div>
